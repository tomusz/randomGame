package org.guessNumber.constants;
...
public class Constants {
    ...
    public static final String PLEASE_PROVIDE_NUMBER_MSG = "Please provide number in range 0 to 99";
    public static final String PLEASE_TRY_AGAIN_MSG = "Please try again %s attempts are left";
    public static final String GAME_LOST_WITH_ANSWER = "Sorry you didn't guess the number, the answer was: %s";
    public static final String PROVIDED_IS_NOT_A_NUMBER_MSG = "Provided element is not a number";
}
